...
\begin{itemize}
\item \textbf{GitHub repository}: \url{https://github.com/arcticoder/energy-tensor-cone} — complete source code, Lean proofs, Mathematica search scripts, and test suites
...
Complete file structure and detailed documentation available at \url{https://github.com/arcticoder/energy-tensor-cone}.
